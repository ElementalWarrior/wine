...
#define WINE_HID_USAGE_PID_NORMAL                   ((USAGE) 0x20)
#define WINE_HID_USAGE_PID_SET_EFFECT_REPORT        ((USAGE) 0x21)
#define WINE_HID_USAGE_PID_EFFECT_BLOCK_INDEX       ((USAGE) 0x22)
#define WINE_HID_USAGE_PID_PARAMETER_BLOCK_OFFSET   ((USAGE) 0x23)
#define WINE_HID_USAGE_PID_ROM_FLAG                 ((USAGE) 0x24)
#define WINE_HID_USAGE_PID_EFFECT_TYPE              ((USAGE) 0x25)
#define WINE_HID_USAGE_PID_ET_CONSTANT_FORCE        ((USAGE) 0x26)
#define WINE_HID_USAGE_PID_ET_RAMP                  ((USAGE) 0x27)
#define WINE_HID_USAGE_PID_ET_CUSTOM_FORCE_DATA     ((USAGE) 0x28)

#define WINE_HID_USAGE_PID_ET_SQUARE                ((USAGE) 0x30)
#define WINE_HID_USAGE_PID_ET_SINE                  ((USAGE) 0x31)
#define WINE_HID_USAGE_PID_ET_TRIANGLE              ((USAGE) 0x32)
#define WINE_HID_USAGE_PID_ET_SAWTOOTH_UP           ((USAGE) 0x33)
#define WINE_HID_USAGE_PID_ET_SAWTOOTH_DOWN         ((USAGE) 0x34)

#define WINE_HID_USAGE_PID_ET_SPRING                ((USAGE) 0x40)
#define WINE_HID_USAGE_PID_ET_DAMPER                ((USAGE) 0x41)
#define WINE_HID_USAGE_PID_ET_INERTIA               ((USAGE) 0x42)
#define WINE_HID_USAGE_PID_ET_FRICTION              ((USAGE) 0x43)

#define WINE_HID_USAGE_PID_DURATION                         ((USAGE) 0x50)
#define WINE_HID_USAGE_PID_SAMPLE_PERIOD                    ((USAGE) 0x51)
#define WINE_HID_USAGE_PID_GAIN                             ((USAGE) 0x52)
#define WINE_HID_USAGE_PID_TRIGGER_BUTTON                   ((USAGE) 0x53)
#define WINE_HID_USAGE_PID_TRIGGER_REPEAT_INTERVAL          ((USAGE) 0x54)
#define WINE_HID_USAGE_PID_AXES_ENABLE                      ((USAGE) 0x55)
#define WINE_HID_USAGE_PID_DIRECTION_ENABLE                 ((USAGE) 0x56)
#define WINE_HID_USAGE_PID_DIRECTION                        ((USAGE) 0x57)
#define WINE_HID_USAGE_PID_TYPE_SPECIFIC_BLOCK_OFFSET       ((USAGE) 0x58)
#define WINE_HID_USAGE_PID_BLOCK_TYPE                       ((USAGE) 0x59)
#define WINE_HID_USAGE_PID_SET_ENVELOPE_REPORT              ((USAGE) 0x5a)
#define WINE_HID_USAGE_PID_ATTACK_LEVEL                     ((USAGE) 0x5b)
#define WINE_HID_USAGE_PID_ATTACK_TIME                      ((USAGE) 0x5c)
#define WINE_HID_USAGE_PID_FADE_LEVEL                       ((USAGE) 0x5d)
#define WINE_HID_USAGE_PID_FADE_TIME                        ((USAGE) 0x5e)
#define WINE_HID_USAGE_PID_SET_CONDITION_REPORT             ((USAGE) 0x5f)
#define WINE_HID_USAGE_PID_CP_OFFSET                        ((USAGE) 0x60)
#define WINE_HID_USAGE_PID_POSITIVE_COEFFICIENT             ((USAGE) 0x61)
#define WINE_HID_USAGE_PID_NEGATIVE_COEFFICIENT             ((USAGE) 0x62)
#define WINE_HID_USAGE_PID_POSITIVE_SATURATION              ((USAGE) 0x63)
#define WINE_HID_USAGE_PID_NEGATIVE_SATURATION              ((USAGE) 0x64)
#define WINE_HID_USAGE_PID_DEAD_BAND                        ((USAGE) 0x65)
#define WINE_HID_USAGE_PID_DOWNLOAD_FORCE_SAMPLE            ((USAGE) 0x66)
#define WINE_HID_USAGE_PID_ISOCH_CUSTOM_FORCE_ENABLE        ((USAGE) 0x67)
#define WINE_HID_USAGE_PID_CUSTOM_FORCE_DATA_REPORT         ((USAGE) 0x68)
#define WINE_HID_USAGE_PID_CUSTOM_FORCE_DATA                ((USAGE) 0x69)
#define WINE_HID_USAGE_PID_CUSTOM_FORCE_VENDOR_DEFINED_DATA ((USAGE) 0x6a)
#define WINE_HID_USAGE_PID_SET_CUSTOM_FORCE_REPORT          ((USAGE) 0x6b)
#define WINE_HID_USAGE_PID_CUSTOM_FORCE_DATA_OFFSET         ((USAGE) 0x6c)
#define WINE_HID_USAGE_PID_SAMPLE_COUNT                     ((USAGE) 0x6d)
#define WINE_HID_USAGE_PID_SET_PERIODIC_REPORT              ((USAGE) 0x6e)
#define WINE_HID_USAGE_PID_OFFSET                           ((USAGE) 0x6f)
#define WINE_HID_USAGE_PID_MAGNITUDE                        ((USAGE) 0x70)
#define WINE_HID_USAGE_PID_PHASE                            ((USAGE) 0x71)
#define WINE_HID_USAGE_PID_PERIOD                           ((USAGE) 0x72)
#define WINE_HID_USAGE_PID_SET_CONSTANT_FORCE_REPORT        ((USAGE) 0x73)
#define WINE_HID_USAGE_PID_SET_RAMP_FORCE_REPORT            ((USAGE) 0x74)
#define WINE_HID_USAGE_PID_RAMP_START                       ((USAGE) 0x75)
#define WINE_HID_USAGE_PID_RAMP_END                         ((USAGE) 0x76)
#define WINE_HID_USAGE_PID_EFFECT_OPERATION_REPORT          ((USAGE) 0x77)
#define WINE_HID_USAGE_PID_EFFECT_OPERATION                 ((USAGE) 0x78)
#define WINE_HID_USAGE_PID_OP_EFFECT_START                  ((USAGE) 0x79)
#define WINE_HID_USAGE_PID_OP_EFFECT_START_SOLO             ((USAGE) 0x7a)
#define WINE_HID_USAGE_PID_OP_EFFECT_STOP                   ((USAGE) 0x7b)
#define WINE_HID_USAGE_PID_LOOP_COUNT                       ((USAGE) 0x7c)
#define WINE_HID_USAGE_PID_DEVICE_GAIN_REPORT               ((USAGE) 0x7d)
#define WINE_HID_USAGE_PID_DEVICE_GAIN                      ((USAGE) 0x7e)
#define WINE_HID_USAGE_PID_POOL_REPORT                      ((USAGE) 0x7f)
#define WINE_HID_USAGE_PID_RAM_POOL_SIZE                    ((USAGE) 0x80)
#define WINE_HID_USAGE_PID_ROM_POOL_SIZE                    ((USAGE) 0x81)
#define WINE_HID_USAGE_PID_ROM_EFFECT_BLOCK_COUNT           ((USAGE) 0x82)
#define WINE_HID_USAGE_PID_SIMULTANEOUS_EFFECTS_MAX         ((USAGE) 0x83)
#define WINE_HID_USAGE_PID_POOL_ALIGNMENT                   ((USAGE) 0x84)
#define WINE_HID_USAGE_PID_POOL_MOVE_REPORT                 ((USAGE) 0x85)
#define WINE_HID_USAGE_PID_MOVE_SOURCE                      ((USAGE) 0x86)
#define WINE_HID_USAGE_PID_MOVE_DESTINATION                 ((USAGE) 0x87)
#define WINE_HID_USAGE_PID_MOVE_LENGTH                      ((USAGE) 0x88)
#define WINE_HID_USAGE_PID_BLOCK_LOAD_REPORT                ((USAGE) 0x89)
#define WINE_HID_USAGE_PID_BLOCK_LOAD_STATUS                ((USAGE) 0x8b)
#define WINE_HID_USAGE_PID_BLOCK_LOAD_SUCCESS               ((USAGE) 0x8c)
#define WINE_HID_USAGE_PID_BLOCK_LOAD_FULL                  ((USAGE) 0x8d)
#define WINE_HID_USAGE_PID_BLOCK_LOAD_ERROR                 ((USAGE) 0x8e)
#define WINE_HID_USAGE_PID_BLOCK_HANDLE                     ((USAGE) 0x8f)
#define WINE_HID_USAGE_PID_BLOCK_FREE_REPORT                ((USAGE) 0x90)
#define WINE_HID_USAGE_PID_TYPE_SPECIFIC_BLOCK_HANDLE       ((USAGE) 0x91)
#define WINE_HID_USAGE_PID_STATE_REPORT                     ((USAGE) 0x92)
#define WINE_HID_USAGE_PID_EFFECT_PLAYING                   ((USAGE) 0x94)
#define WINE_HID_USAGE_PID_DEVICE_CONTROL_REPORT            ((USAGE) 0x95)
#define WINE_HID_USAGE_PID_DEVICE_CONTROL                   ((USAGE) 0x96)
#define WINE_HID_USAGE_PID_DC_ENABLE_ACTUATORS              ((USAGE) 0x97)
#define WINE_HID_USAGE_PID_DC_DISABLE_ACTUATORS             ((USAGE) 0x98)
#define WINE_HID_USAGE_PID_DC_STOP_ALL_EFFECTS              ((USAGE) 0x99)
#define WINE_HID_USAGE_PID_DC_DEVICE_RESET                  ((USAGE) 0x9a)
#define WINE_HID_USAGE_PID_DC_DEVICE_PAUSE                  ((USAGE) 0x9b)
#define WINE_HID_USAGE_PID_DC_DEVICE_CONTINUE               ((USAGE) 0x9c)
#define WINE_HID_USAGE_PID_DEVICE_PAUSED                    ((USAGE) 0x9f)
#define WINE_HID_USAGE_PID_ACTUATORS_ENABLED                ((USAGE) 0xa0)
#define WINE_HID_USAGE_PID_SAFETY_SWITCH                    ((USAGE) 0xa4)
#define WINE_HID_USAGE_PID_ACTUATOR_OVERRIDE_SWITCH         ((USAGE) 0xa5)
#define WINE_HID_USAGE_PID_ACTUATOR_POWER                   ((USAGE) 0xa6)
#define WINE_HID_USAGE_PID_START_DELAY                      ((USAGE) 0xa7)
#define WINE_HID_USAGE_PID_PARAMETER_BLOCK_SIZE             ((USAGE) 0xa8)
#define WINE_HID_USAGE_PID_DEVICE_MANAGED_POOL              ((USAGE) 0xa9)
#define WINE_HID_USAGE_PID_SHARED_PARAMETER_BLOCKS          ((USAGE) 0xaa)
#define WINE_HID_USAGE_PID_CREATE_NEW_EFFECT_REPORT         ((USAGE) 0xab)
#define WINE_HID_USAGE_PID_RAM_POOL_AVAILABLE               ((USAGE) 0xac)
